/* GESMS V10.7.2 - unified evangelism workbook + monthly project accordion */
(function(){
'use strict';
...
function renderProjects(){
  ...
  summary.innerHTML=`<div class="soul-kpis"><div><span>전체</span><b>${projects.length}</b></div><div><span>진행중</span><b>${counts['진행중']}</b></div><div><span>완료</span><b>${counts['완료']}</b></div><div><span>예산 집행</span><b>${budget?Math.round(spent/budget*100):0}%</b></div></div><div class="project-view-guide">📅 월을 선택하거나 월 제목을 누르면 해당 계획만 펼쳐집니다.</div>`;
